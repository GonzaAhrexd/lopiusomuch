...
function LoveYou({handleBack}) {
  return (
    ...
    <div className='lovingyou'>
      <h1>Te amo mucho</h1>
      <p>Hola mi amor, en estos momentos seguramente estoy en el avión y no puedo hablarte. Antes de viajar preparé esta pequeña web App para que tengas una parte de mí en lo que no estoy, no te preocupes que ni bien llego te voy a hablar y mandar fotitos, si mi batería agunta, claro jsjs, hay un contador con el que podés ir viendo apróximadamente a qué hora estoy por llegar y espero que te guste este pequeño regalito que te hice  uwu. </p>
